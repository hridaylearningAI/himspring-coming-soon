...
/* [07] outro — the landscape bookend, then the call to action.
   ...
   The line rises out of the ridge rather than fading in on top of it. That
  ...
  return (
    <>
      {/* id="commitment" is the nav's "Our Commitment" target. This section is
          the closest thing on the page to that: it runs on
          natures-finest-expression.jpg and its one line is the provenance claim
          the whole page has been building to. Landing here puts the reader at
          the top of the beat, with the line still behind the ridge and the rise
          ahead of them, which is the start of the gesture rather than the
          middle of it.
